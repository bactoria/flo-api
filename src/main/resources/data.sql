Insert into Album (title) values ('제모옥');
...
Insert into song (length, title, track, album_id) values(182,'머신과함께 춤을', 1, 1);
Insert into song (length, title, track, album_id) values(210,'머신과함께 밥을', 2, 1);